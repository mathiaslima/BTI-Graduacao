...
int main(){
	int i, j, aux2=0, aux=0, aux3=0, auxR6=0;
	...
	// regra 2
	if (vetorContr[3] == 1 && aux3 == 1 && ( aux == 1 || aux == 0))
	{
	...
	// regra 7
	if (aux == 0 && vetorContr[0]==0 && vetorContr[1]==0 && vetorContr[2]==0 && vetorContr[3]==0 && vetorContr[4]==0)
	{
